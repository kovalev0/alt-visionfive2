...
Этот репозиторий содержит материалы
**[курса по низкоуровневому программированию](./labs/INDEX.md)**,
включая инструкции, конфигурационные файлы и готовую прошивку для
развёртывания ALT Linux на плате StarFive VisionFive2 (RISC-V).
...
## Лицензия
Этот проект распространяется на условиях свободной лицензии
GNU General Public License v3.0. Подробную информацию можно найти
в файле LICENSE.
