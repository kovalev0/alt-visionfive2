...
Mount the newly created partitions and extract the ALT Linux rootfs
tarball.
...
experience, you can build and install a custom kernel using the [gear-hsh-wrapper](https://github.com/kovalev0/gear-hsh-wrapper).
